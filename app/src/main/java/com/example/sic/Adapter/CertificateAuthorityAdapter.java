...
public class CertificateAuthorityAdapter extends RecyclerView.Adapter<CertificateAuthorityAdapter.ViewHolder> {
    int row_index;
    ...
    public CertificateAuthorityAdapter(List<CertificateCA> certificateAuthorities, TextView txt_select_id) {
        this.certificateCa = certificateAuthorities;
        this.txt_select_id = txt_select_id;
    }

    public CertificateAuthorityAdapter(List<CertificateCA> certificateCa, TextView txt_select_id, BottomSheetDialog bottomSheetDialog) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.bottom_sheet_layout_add_new_certificate, parent, false);
