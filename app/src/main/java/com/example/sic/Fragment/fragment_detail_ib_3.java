 ...
 * Use the {@link fragment_detail_ib_3#newInstance} factory method to
 * create an instance of this fragment.
 */
public class fragment_detail_ib_3 extends Fragment {
    ...
    public static fragment_detail_ib_3 newInstance(String param1, String param2) {
        fragment_detail_ib_3 fragment = new fragment_detail_ib_3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_detail_ib_3, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rc_message = view.findViewById(R.id.rc_ib_detail_3);
        arrayList = init();
    ...
    public ArrayList<Ib_detail> init() {
        ...
        tmp.add(new Ib_detail("Perform at", "Operating System", "Windows 10", "IP Address", "192.168.3.14", "Browser", "Chrome 107.9", "RP", "Backoffice_Rp"));
        return tmp;
    }
}