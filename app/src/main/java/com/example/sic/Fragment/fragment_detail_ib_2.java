 ...
 * Use the {@link fragment_detail_ib_2#newInstance} factory method to
 * create an instance of this fragment.
 */
public class fragment_detail_ib_2 extends Fragment {
    ...
    public static fragment_detail_ib_2 newInstance(String param1, String param2) {
        fragment_detail_ib_2 fragment = new fragment_detail_ib_2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_detail_ib_2, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        rc_message = view.findViewById(R.id.rc_ib_detail_2);
        arrayList = init();
