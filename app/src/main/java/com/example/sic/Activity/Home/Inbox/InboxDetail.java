...
import com.example.sic.Activity.Setting_Help.Setting_Detail.ManageCertificate.Certificates.CertificateMoreDetail;
...
public class InboxDetail extends DefaultActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        see_more.setOnClickListener(view -> {
            inbox = 1;
            Intent intent= new Intent(InboxDetail.this, CertificateMoreDetail.class);
        ...
        btnBack.setOnClickListener(view -> {
            Intent intent = new Intent(InboxDetail.this, InboxConfirm.class);
            intent.putExtra("transactionId", transactionID);
            startActivity(intent);
            finish();
        });
