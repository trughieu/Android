...
public class ScanQRDetail extends DefaultActivity {
            ...
            switch (pinValue.length()) {
                ...
                case 6:
                    ...
                    if (pinValue.getText().toString().equals(otp)) {
                        dialog.dismiss();
                        Dialog dialog1 = new Dialog(ScanQRDetail.this);
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                dialog1.dismiss();
                                Intent intent = new Intent(ScanQRDetail.this, HomePage.class);
                        ...
                        Dialog dialog = new Dialog(ScanQRDetail.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new Dialog(ScanQRDetail.this);
        ...
        txt_select_id.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(ScanQRDetail.this, R.style.BottomSheetDialogTheme);
                ...
                checked2 = PreferenceManager.getDefaultSharedPreferences(ScanQRDetail.this).getBoolean("check_inbox_detail_2", false);
                checked3 = PreferenceManager.getDefaultSharedPreferences(ScanQRDetail.this).getBoolean("check_inbox_detail_3", false);
                checked4 = PreferenceManager.getDefaultSharedPreferences(ScanQRDetail.this).getBoolean("check_inbox_detail_4", false);
                ...
                conf_with_bio.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        PreferenceManager.getDefaultSharedPreferences(ScanQRDetail.this).edit().putBoolean("check_inbox_detail_2", false).apply();
                        PreferenceManager.getDefaultSharedPreferences(ScanQRDetail.this).edit().putBoolean("check_inbox_detail_3", true).apply();
                        PreferenceManager.getDefaultSharedPreferences(ScanQRDetail.this).edit().putBoolean("check_inbox_detail_4", false).apply();
                ...
                conf_with_pin.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        txt_select_id.setText(s);
                        PreferenceManager.getDefaultSharedPreferences(ScanQRDetail.this).edit().putBoolean("check_inbox_detail_2", false).apply();
                        PreferenceManager.getDefaultSharedPreferences(ScanQRDetail.this).edit().putBoolean("check_inbox_detail_3", false).apply();
                        PreferenceManager.getDefaultSharedPreferences(ScanQRDetail.this).edit().putBoolean("check_inbox_detail_4", true).apply();
                        bottomSheetDialog.dismiss();
                ...
                conf_with_E_identify.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        txt_select_id.setText(s);
                        PreferenceManager.getDefaultSharedPreferences(ScanQRDetail.this).edit().putBoolean("check_inbox_detail_2", true).apply();
                        PreferenceManager.getDefaultSharedPreferences(ScanQRDetail.this).edit().putBoolean("check_inbox_detail_3", false).apply();
                        PreferenceManager.getDefaultSharedPreferences(ScanQRDetail.this).edit().putBoolean("check_inbox_detail_4", false).apply();
                        bottomSheetDialog.dismiss();
