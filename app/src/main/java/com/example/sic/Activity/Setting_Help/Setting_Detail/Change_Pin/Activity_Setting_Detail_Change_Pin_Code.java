...
public class Activity_Setting_Detail_Change_Pin_Code extends DefaultActivity {
    FrameLayout btnBack;
...
//                            text = text.substring(0, text.length() - 1);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setting_detail_change_pin_code);
        ...
        SharedPreferences pref = getSharedPreferences("MY_6_DIGIT", MODE_PRIVATE);
        try {
            current_pin = decrypt(getApplicationContext(), pref.getString("my_6_digit", null));
        } catch (Exception e) {
