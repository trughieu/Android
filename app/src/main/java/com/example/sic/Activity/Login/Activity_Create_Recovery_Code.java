...
public class Activity_Create_Recovery_Code extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_recovery_code);
        AnhXa();
...
//            try {
//                ActivateModule.createModule(Activity_Create_Recovery_Code.this).setResponseSetRecoveryCode(new HttpRequest.AsyncResponse() {
//                    @Override
...
//            }
    ...
    private void Dialog() {
        Dialog dialog = new Dialog(Activity_Create_Recovery_Code.this);
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent = new Intent(Activity_Create_Recovery_Code.this, HomePage.class);
                startActivity(intent);
                finish();
            }
        }, 2000);
