...
import com.example.sic.Activity.InboxDetailSubmit;
...
public class InboxConfirm extends DefaultActivity implements View.OnClickListener {
            ...
            switch (pinValue.length()) {
                ...
                case 6:
                    ...
                    if (pinValue.getText().toString().equals(otp)) {
                        ...
                        Dialog dialog = new Dialog(InboxConfirm.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new Dialog(InboxConfirm.this);
...
//                }
        ...
        btn_Detail.setOnClickListener(view -> {
            intent = new Intent(InboxConfirm.this, InboxDetail.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        ...
        txt_select_id.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(InboxConfirm.this, R.style.BottomSheetDialogTheme);
                ...
                checked1 = PreferenceManager.getDefaultSharedPreferences(InboxConfirm.this).getBoolean("check_inbox_detail_1", false);
                checked2 = PreferenceManager.getDefaultSharedPreferences(InboxConfirm.this).getBoolean("check_inbox_detail_2", false);
                checked3 = PreferenceManager.getDefaultSharedPreferences(InboxConfirm.this).getBoolean("check_inbox_detail_3", false);
                checked4 = PreferenceManager.getDefaultSharedPreferences(InboxConfirm.this).getBoolean("check_inbox_detail_4", false);
                ...
                approve_later.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        PreferenceManager.getDefaultSharedPreferences(InboxConfirm.this).edit().putBoolean("check_inbox_detail_1", true).apply();
                        PreferenceManager.getDefaultSharedPreferences(InboxConfirm.this).edit().putBoolean("check_inbox_detail_2", false).apply();
                        PreferenceManager.getDefaultSharedPreferences(InboxConfirm.this).edit().putBoolean("check_inbox_detail_3", false).apply();
                        PreferenceManager.getDefaultSharedPreferences(InboxConfirm.this).edit().putBoolean("check_inbox_detail_4", false).apply();
                ...
                conf_with_bio.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        txt_select_id.setText(s);
                        PreferenceManager.getDefaultSharedPreferences(InboxConfirm.this).edit().putBoolean("check_inbox_detail_1", false).apply();
                        PreferenceManager.getDefaultSharedPreferences(InboxConfirm.this).edit().putBoolean("check_inbox_detail_2", false).apply();
                        PreferenceManager.getDefaultSharedPreferences(InboxConfirm.this).edit().putBoolean("check_inbox_detail_3", true).apply();
                        PreferenceManager.getDefaultSharedPreferences(InboxConfirm.this).edit().putBoolean("check_inbox_detail_4", false).apply();
                        bottomSheetDialog.dismiss();
                ...
                conf_with_pin.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        PreferenceManager.getDefaultSharedPreferences(InboxConfirm.this).edit().putBoolean("check_inbox_detail_2", false).apply();
                        PreferenceManager.getDefaultSharedPreferences(InboxConfirm.this).edit().putBoolean("check_inbox_detail_3", false).apply();
                        PreferenceManager.getDefaultSharedPreferences(InboxConfirm.this).edit().putBoolean("check_inbox_detail_4", true).apply();
                        bottomSheetDialog.dismiss();
                ...
                conf_with_E_identify.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        txt_select_id.setText(s);
                        PreferenceManager.getDefaultSharedPreferences(InboxConfirm.this).edit().putBoolean("check_inbox_detail_1", false).apply();
                        PreferenceManager.getDefaultSharedPreferences(InboxConfirm.this).edit().putBoolean("check_inbox_detail_2", true).apply();
                        PreferenceManager.getDefaultSharedPreferences(InboxConfirm.this).edit().putBoolean("check_inbox_detail_3", false).apply();
                        PreferenceManager.getDefaultSharedPreferences(InboxConfirm.this).edit().putBoolean("check_inbox_detail_4", false).apply();
                        bottomSheetDialog.dismiss();
