...
public class AddCertificate6digit extends DefaultActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_certificate6digit);
    ...
    private void showBottomSheetDialog() {
        BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(AddCertificate6digit.this, R.style.BottomSheetDialogTheme);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.btnContinue:
                ...
                module.setResponseCredentialsSendActivationCode(new HttpRequest.AsyncResponse() {
                    ...
                    public void process(boolean b, Response response) {
                        if (response.getError() == 0) {
                            stop();
                            Intent intent = new Intent(view.getContext(), AddCertificateStep1.class);
                ...
                break;
            case R.id.btnBack:
                intent = new Intent(AddCertificate6digit.this, Manage_Certificate.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                finish();
                break;
            case R.id.choose:
                intent = new Intent(AddCertificate6digit.this, AddCertificate8digit.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                finish();
