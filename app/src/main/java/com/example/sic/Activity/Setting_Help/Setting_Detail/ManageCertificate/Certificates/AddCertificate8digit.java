...
public class AddCertificate8digit extends DefaultActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_certificate8digit);
        ...
        choose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), AddCertificate6digit.class);
                    ...
                    public void process(boolean b, Response response) {
                        if (response.getError() == 0) {
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    stop();
                                    Intent intent = new Intent(v.getContext(), AddCertificateStep1.class);
                                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
    ...
    private void showBottomSheetDialog() {
        BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(AddCertificate8digit.this, R.style.BottomSheetDialogTheme);
