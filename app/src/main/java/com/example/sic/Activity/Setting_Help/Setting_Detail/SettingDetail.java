...
import com.example.sic.Activity.Setting_Help.Setting_Detail.ChangePassword.ChangePassword;
import com.example.sic.Activity.Setting_Help.Setting_Detail.Change_Pin.ChangePinStep1;
import com.example.sic.Activity.Setting_Help.Setting_Detail.ManageCertificate.Manage_Certificate;
import com.example.sic.Activity.Setting_Help.Setting_Detail.Manage_Order.ManageOrder;
import com.example.sic.Activity.Setting_Help.Setting_Detail.Manage_Sim.ManageSim;
...
public class  SettingDetail extends DefaultActivity implements View.OnClickListener {

    AppCompatCheckBox checkBox1, checkBox2, checkBox3, checkBox4;
    LinearLayout changePin, changeRecoverAccount, deleteAccount, manageCertificate, manageSim, manageOrder, actionHistory,changePassword, check1, check2, check3, check4;
    TextView btn_Ok, btn_Cancel, btn_Ok_dialog1, btn_Cancel_dialog1, btn_Ok_dialog2, confirm, user_name, btnClose;
    ImageView show_password;
    boolean checked1, checked2, checked3, checked4, authentication, verification, approve,sim;
    SwitchCompat check_biometrics, approve_later_switch, verification_code_switch, authentication_switch, direct_sim_switch;
            ...
            switch (pinValue.length()) {
                ...
                case 6:
                    ...
                    if (pinValue.getText().toString().equals(digit)) {
                        ...
                        Dialog dialog = new Dialog(SettingDetail.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bool_transaction = getSharedPreferences("transaction", MODE_PRIVATE).edit();
        SharedPreferences transaction = getSharedPreferences("transaction", MODE_PRIVATE);

        authentication = transaction.getBoolean("authMethod", false);
        verification = transaction.getBoolean("verifiedCode", false);
        approve = transaction.getBoolean("approve", false);
        sim=transaction.getBoolean("sim",false);
        ...
        direct_sim_switch.setChecked(sim);
    ...
    public void onClick(@NonNull View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.id_chang_pin:
                intent = new Intent(SettingDetail.this, ChangePinStep1.class);
            ...
            case R.id.id_recover_account:
                intent = new Intent(SettingDetail.this, MainActivity.class);
            ...
            case R.id.id_manage_certificate:
                intent = new Intent(SettingDetail.this, Manage_Certificate.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                finish();
            ...
            case R.id.id_manage_sim:
                intent = new Intent(SettingDetail.this, ManageSim.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                finish();
            ...
            case R.id.id_manage_order:
                intent = new Intent(SettingDetail.this, ManageOrder.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                finish();
                break;
            case R.id.btnBack:
                intent = new Intent(SettingDetail.this, SettingHelp.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);                startActivity(intent);
                finish();
                break;
            case R.id.id_action_history:
                intent = new Intent(SettingDetail.this, ActionHistory.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            ...
            case R.id.authentication_switch:
                if (authentication_switch.isChecked()) {
                    bool_transaction.putBoolean("authMethod", authentication_switch.isChecked());
                    bool_transaction.apply();

                } else {
                    bool_transaction.putBoolean("authMethod", false);
                    bool_transaction.apply();
                }
                break;
            case R.id.verification_code_switch:
                if (verification_code_switch.isChecked()) {
                    bool_transaction.putBoolean("verifiedCode", verification_code_switch.isChecked());
                    bool_transaction.apply();
                } else {
                    bool_transaction.putBoolean("verifiedCode", false);
                    bool_transaction.apply();
                }
                break;
            case R.id.approve_later_switch:
                if (approve_later_switch.isChecked()) {
                    bool_transaction.putBoolean("approve", approve_later_switch.isChecked());
                    bool_transaction.apply();
                } else {

                    bool_transaction.putBoolean("approve", false);
                    bool_transaction.apply();
                }
                break;
            case R.id.direct_sim_switch:
                if (direct_sim_switch.isChecked()) {
                    bool_transaction.putBoolean("sim", direct_sim_switch.isChecked());
                    bool_transaction.apply();
                } else {
                    bool_transaction.putBoolean("sim", false);
                    bool_transaction.apply();
                }
                break;
            case R.id.id_change_password:
                intent = new Intent(SettingDetail.this, ChangePassword.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                finish();
    ...
    private void Dialog_delete_account() {
        ...
        btn_Ok.setOnClickListener(view1 -> {
            ...
            btn_Ok_dialog1.setOnClickListener(view2 -> {
                dialog1.dismiss();
                Dialog dialog2 = new Dialog(SettingDetail.this);
    ...
    private void anh_xa() {
        ...
        direct_sim_switch = findViewById(R.id.direct_sim_switch);
        changePin = findViewById(R.id.id_chang_pin);
        manageCertificate = findViewById(R.id.id_manage_certificate);
        changeRecoverAccount = findViewById(R.id.id_recover_account);
        deleteAccount = findViewById(R.id.id_delete_account);
        manageSim = findViewById(R.id.id_manage_sim);
        manageOrder = findViewById(R.id.id_manage_order);
        actionHistory = findViewById(R.id.id_action_history);
        btnBack = findViewById(R.id.btnBack);
        changePassword=findViewById(R.id.id_change_password);
    ...
    private void set_click() {
        ...
        changeRecoverAccount.setOnClickListener(this);
        deleteAccount.setOnClickListener(this);
        manageOrder.setOnClickListener(this);
        manageSim.setOnClickListener(this);
        manageCertificate.setOnClickListener(this);
        actionHistory.setOnClickListener(this);
        ...
        direct_sim_switch.setOnClickListener(this);
        changePassword.setOnClickListener(this);
    }

    private void biometrics_click() {
        BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(SettingDetail.this, R.style.BottomSheetDialogTheme);
    ...
    private void Dialog_pin() {
        dialog = new Dialog(SettingDetail.this);
