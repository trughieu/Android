...
public class AddCertificateStep1 extends DefaultActivity implements View.OnClickListener {
    String s;
    FrameLayout btnBack;
...
//                        dialog1.setCanceledOnTouchOutside(false);
                        ...
                        Dialog dialog = new Dialog(AddCertificateStep1.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_Detail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), AddCertificateDetail.class);
                intent.putExtra("response", response);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(intent);
        ...
        txt_select_id.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(
                        AddCertificateStep1.this, R.style.BottomSheetDialogTheme);
                ...
                checked1 = PreferenceManager.getDefaultSharedPreferences(AddCertificateStep1.this)
                        .getBoolean("check_manage_add_new_certificate_1", false);
                checked2 = PreferenceManager.getDefaultSharedPreferences(AddCertificateStep1.this)
                        .getBoolean("check_manage_add_new_certificate_2", false);
                checked3 = PreferenceManager.getDefaultSharedPreferences(AddCertificateStep1.this)
                ...
                conf_Pin.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        PreferenceManager.getDefaultSharedPreferences(AddCertificateStep1.this).edit()
                        ...
                        dialog = new Dialog(AddCertificateStep1.this);
...
//                        dialog1.setCanceledOnTouchOutside(false);
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.btnBack || view.getId() == R.id.tv_Cancel) {
            intent = new Intent(AddCertificateStep1.this, AddCertificate6digit.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
            finish();
        } else if (view.getId() == R.id.btn_Detail) {
            intent = new Intent(AddCertificateStep1.this, AddCertificateDetail.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
