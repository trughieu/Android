...
import static com.example.sic.Activity.Home.Inbox.InboxDetail.inbox;
...
import com.example.sic.Activity.Home.Inbox.InboxDetail;
...
public class CertificateMoreDetail extends DefaultActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.certificate_more_detail);
        anh_xa();
        start();
        ...
        btnBack.setOnClickListener(view -> {
            Intent intent;
            if (inbox == 1) {
                intent = new Intent(this, InboxDetail.class);
            } else {
                intent = new Intent(this, CertificateDetail.class);
            }
