...
public class ChangePinStep3 extends DefaultActivity {
    FrameLayout btnBack;
            ...
            switch (pinValue.getText().toString().length()) {
                ...
                case 6:
                    ...
                    if (!pinValue.getText().toString().equals(otp)) {
                        ...
                        Dialog dialog = new Dialog(ChangePinStep3.this);
...
//                            text = text.substring(0, text.length() - 1);
                        ...
                        handler.postDelayed(new Runnable() {
                            public void run() {
                                Intent intent= new Intent(ChangePinStep3.this, SettingDetail.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.changepinstep3);
