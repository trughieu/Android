...
public class ChangePinStep2 extends DefaultActivity {
    FrameLayout btnBack;
            ...
            switch (pinValue.getText().toString().length()) {
                ...
                case 6:
                    ...
                    if (pinValue.getText().toString().equals(otp)) {
                        ...
                        Dialog dialog = new Dialog(ChangePinStep2.this);
...
//                            text = text.substring(0, text.length() - 1);
                        ...
                        Intent intent= new Intent(ChangePinStep2.this,
                                ChangePinStep3.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.changepinstep2);
