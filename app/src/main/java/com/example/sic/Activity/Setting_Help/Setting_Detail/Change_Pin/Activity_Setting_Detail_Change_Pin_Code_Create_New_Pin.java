...
public class Activity_Setting_Detail_Change_Pin_Code_Create_New_Pin extends DefaultActivity {
    FrameLayout btnBack;
            ...
            switch (pinValue.getText().toString().length()) {
                ...
                case 6:
                    ...
                    if (pinValue.getText().toString().equals(otp)) {
                        ...
                        Dialog dialog = new Dialog(Activity_Setting_Detail_Change_Pin_Code_Create_New_Pin.this);
                        dialog.setContentView(R.layout.dialog_fail_pin_different);
...
//                            text = text.substring(0, text.length() - 1);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setting_detail_change_pin_code_create_new_pin);
