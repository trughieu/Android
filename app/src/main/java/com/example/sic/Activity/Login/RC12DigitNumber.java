...
public class RC12DigitNumber extends AppCompatActivity {
            ...
            switch (pinValue.length()) {
                ...
                case 14:
                    ...
                    txt_pin_view12.setText(text);
                        try {
                            ActivateModule.createModule(RC12DigitNumber.this).setResponseSetRecoveryCode(new HttpRequest.AsyncResponse() {
                                @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rc12_digit_number);
        anh_xa();
        ...
        digit_number.setOnClickListener(view -> {
            Intent intent= new Intent(this, RC6DigitNumber.class);
    ...
    private void Dialog() {
        Dialog dialog = new Dialog(RC12DigitNumber.this);
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent= new Intent(RC12DigitNumber.this, HomePage.class);
               startActivity(intent);
                finish();
            }
        }, 2000);
