...
public class ChangeScal extends DefaultActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.change_scal);
        ...
        module = CertificateProfilesModule.createModule(ChangeScal.this);
...
//                value_scal = response.getSCAL();
        ...
        txt_select_id.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(ChangeScal.this, R.style.BottomSheetDialogTheme);
                ...
                btnBack.setOnClickListener(view1 -> {
                    Intent intent= new Intent(ChangeScal.this,
    ...
    public void onClick(@NonNull View view) {
        switch (view.getId()) {
            ...
            case R.id.checkBox8:
                ...
                break;
            case R.id.btnBack:
                Intent intent= new Intent(ChangeScal.this, Manage_Certificate.class);
               startActivity(intent);
                finish();
        }
    }
