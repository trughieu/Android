...
public class Register extends DefaultActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.btnContinue:
                ...
                if (id == 1) {
                    i = new Intent(Register.this, Register_1.class);
                    startActivity(i);

                } else if (id == 2) {
                    i = new Intent(Register.this, Register_2.class);
                    startActivity(i);
                }
