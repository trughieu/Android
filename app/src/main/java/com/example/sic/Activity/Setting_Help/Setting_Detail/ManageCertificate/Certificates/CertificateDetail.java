...
public class CertificateDetail extends DefaultActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_select_id.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(CertificateDetail.this, R.style.BottomSheetDialogTheme);
    ...
    private void Dialog_PIN() {
        Dialog dialog = new Dialog(CertificateDetail.this);
    ...
    private void dialog_success_bio() {
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent= new Intent(getApplicationContext(), CertificateDetail.class);
                intent.putExtra("id",credentialID);
                startActivity(intent);
                finish();
                dialog.dismiss();
